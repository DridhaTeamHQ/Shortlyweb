...
const Navbar = () => {
    ...
    const handleScroll = () => {
      if (!ticking) {
        window.requestAnimationFrame(() => {
          ...
          // Update active section based on scroll position - ONLY if we are on home page
  ...
  const scrollToSection = (sectionId) => {
    ...
    if (location.pathname !== '/') {
      ...
      // This is a simple workaround, a more robust solution would involve a context or route state
      setTimeout(() => {
        ...
        <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                {navItems.map((item) => (
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`px-6 py-2 rounded-full font-medium transition-all duration-300 ${activeSection === item.id
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <motion.a
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`w-full h-full flex items-center justify-center transition-colors duration-300 ${theme === 'light' ? 'text-purple-800 hover:text-purple-900' : 'text-purple-300 hover:text-white'
                      }`}
                  >
              ...
              >
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className={`w-full h-full font-semibold transition-colors duration-300 flex items-center justify-center ${theme === 'light' ? 'text-purple-800 hover:text-purple-900' : 'text-purple-300 hover:text-white'
                    }`}
                >
                  Download App
                </motion.a>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`md:hidden p-3 rounded-lg transition-colors duration-300 ${theme === 'light' ? 'bg-purple-100 text-purple-800' : 'bg-purple-900/30 text-purple-300'
                }`}
          ...
          <div className="flex flex-col gap-2">
            {navItems.map((item) => (
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="button"
                className={`px-4 py-3 rounded-lg font-medium text-left transition-all duration-300 ${activeSection === item.id
                  ? theme === 'light' ? 'bg-purple-200 text-purple-800' : 'bg-purple-500/30 text-purple-300'
