...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className={`py-16 sm:py-20 md:py-24 px-4 overflow-hidden scroll-mt-24 w-full relative ${theme === 'light' ? 'bg-[#f5f3ff]' : 'bg-[#0a0518]'
      }`}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className={`absolute -top-20 -left-20 w-[360px] h-[360px] rounded-full blur-[100px] ${theme === 'light' ? 'bg-purple-300/40' : 'bg-purple-800/15'}`}
        />
        <motion.div
          animate={{ x: [0, -40, 0], y: [0, 40, 0], scale: [1, 1.2, 1] }}
          transition={{ duration: 26, repeat: Infinity, ease: "linear" }}
          className={`absolute top-1/3 -right-20 w-[320px] h-[320px] rounded-full blur-[100px] ${theme === 'light' ? 'bg-blue-200/30' : 'bg-blue-800/10'}`}
        />
        <motion.div
          animate={{ x: [0, 30, 0], y: [0, 20, 0], scale: [1, 1.08, 1] }}
          transition={{ duration: 18, repeat: Infinity, ease: "linear" }}
          className={`absolute -bottom-16 left-1/4 w-[400px] h-[400px] rounded-full blur-[120px] ${theme === 'light' ? 'bg-pink-200/30' : 'bg-pink-900/8'}`}
        />
      </div>
        ...
        >
          <div className="inline-block mb-6">
            <GlassSurface
              ...
              mixBlendMode="normal"
            >
              <div className={`w-full h-full flex items-center justify-center ${theme === 'light' ? 'text-purple-600' : 'text-purple-300'
                }`}>
          ...
          <h2 className={`text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-3 ${theme === 'light'
          ...
          >
            <div className={`rounded-3xl p-6 sm:p-8 md:p-10 backdrop-blur-2xl relative overflow-hidden ${theme === 'light'
              ...
              <div className="relative z-10">
                <h3 className={`text-xl sm:text-2xl font-bold mb-6 sm:mb-8 ${theme === 'light' ? 'text-gray-800' : 'text-white'}`}>
                  Send us a Message
                </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="flex items-start gap-3">
                    <input
                      ...
                      onChange={handleChange}
                      id="authorize-section"
                      required
                      className="mt-0.5 w-4 h-4 rounded border-gray-300 text-purple-600 focus:ring-purple-500 flex-shrink-0"
                    />
                    <label htmlFor="authorize-section" className={`text-xs sm:text-sm leading-relaxed ${theme === 'light' ? 'text-gray-500' : 'text-gray-400'}`}>
